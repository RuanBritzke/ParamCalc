from math import acos, asin, atan, cos, degrees, isnan, radians, sin, sqrt
...
class MainWindow(Screen):
    ...
    def listar_fabricantes(self):
        ...
        self.box_popup.add_widget(
            Button(
                text='ITB',
                on_release= self.selecionar_fabricante
        ))
        self.box_popup.add_widget(
            Button(
                text='Siemens',
...
class Calculadora(Screen):
    ...
    def atualizar_resultados(self, S: str, P: str, Q:str, phi:str, FP:str, V:str, I:str):
    ...
    def  calcular_phi(self, S, P, Q, phi, FP, V, I):
        ...
        if bool(Q) * bool(P):
            ...
            return old_phi
        return str(round(degrees(phi),2)) if not isnan(phi) else old_phi
